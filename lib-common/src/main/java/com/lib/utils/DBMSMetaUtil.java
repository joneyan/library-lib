...
public class DBMSMetaUtil {
    ...
    public static void demoDatabaseMetaData() {
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://"+ GetDataConstant.DB_PATH+"/"+GetDataConstant.DB_NAME, "root", "Chenyi123");
            //
            ...
            rs = dmd.getPrimaryKeys(null, null, GetDataConstant.DB_TABLENAME);
            while (rs.next()) {
                System.out.println(rs.getString(3) + "表的主键是：" + rs.getString(4));
            }
            System.out.println("========================================");

            rs = dmd.getColumns(null, null, GetDataConstant.DB_TABLENAME, "%");
