                ...
                <tr>
                    ...
                    <td style="text-align: center;font-size: large;">
                        <div class="btn-group" role="group" aria-label="...">
                            <button class="borrowbook" type="button" class="btn btn-default" style="background-color: peachpuff"  typeid="${case.id}" <#if case.leftnum lt 1> disabled="disabled"</#if>>
                                <span class="glyphicon glyphicon-floppy-save" style="color: #18d4cb;" aria-hidden="true" ><font style="font-size: large">&nbsp;借出</font></span>
                            </button>
                        </div>
                    </td>
                </tr>
