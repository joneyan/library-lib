        ...
        <section class="wrapper">
            <div class="panel panel-primary">
                ...
                <div class="list-group">
                    <a href="${pagecontext.request.getcontextpath}/library/libraryInfo" class="list-group-item active" style="text-align: center;"><h3>图书馆详细信息</h3></a>
                    <a href="#" class="list-group-item success" style="text-align: center;background-color: plum"><h3>修改图书馆信息</h3></a>
                    <a href="#" class="list-group-item error" style="text-align: center;background-color: peachpuff"><h3>图书馆介绍</h3></a>
                    <a href="#" class="list-group-item info" style="text-align: center;background-color: deepskyblue"><h3>修改图书馆介绍</h3></a>
                </div>
            </div>
        </section>
    </section>
