    ...
    <section id="main-content">
        <section class="wrapper" style="background-image: url('${pagecontext.request.contextpath}/img/tsg2.jpg');height: 800px;">
            <ul class="nav nav-tabs">
                <li role="presentation" class="" style="background-color:lawngreen"><a href="${pagecontext.request.contextpath}/press/getbookepresslist">出版社列表</a></li>
                <li role="presentation" class="active" style="background-color: hotpink"><a href="javascript:void(0)">新增出版社</a></li>
            </ul>
            <span style="text-align: center;color: red" id="sp1">${message}</span>
            <form id="saveCaseInfo" action="${pagecontext.request.getcontextpath}/press/savePressInfo" method="post">
                <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-info-sign" aria-hidden="true">&nbsp;出版社名：</span></span>
                    <input type="text" name="pubname" id="pubname" class="form-control"
                           value="${pubname}"  aria-describedby="basic-addon1">
                </div>
                <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-info-sign" aria-hidden="true">&nbsp;可用状态：</span></span>
                ...
                <div class="btn-group" role="group" aria-label="...">
                    <button type="button" class="btn btn-default" style="background-color: peachpuff" onclick="savePressInfo()">
