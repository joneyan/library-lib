    ...
    <section id="main-content">
        <section class="wrapper" >
            ...
            <table class="table table-striped" style="text-align: center; table-layout: fixed;border-radius: 5px;" cellspacing="0" border="1">
                <caption style="color: #18d4cb;font-size: 30px;">管理员列表</caption>
                <tr>
                    <th style="text-align: center;">编号</th>
                    <th style="text-align: center;">管理账号</th>
                    <th style="text-align: center;">管理权限</th>
                    <th style="text-align: center;">操作</th>
                </tr>
            <#list pagebean.pageElements as case>
                <tr>
                    <td style="text-align: center;font-size: large;">${case.id}</td>
                    <td style="text-align: center;font-size: large;">${case.username}</td>
                    <td style="text-align: center;font-size: large;"><#if case.status==2>管理员</#if><#if case.status==1>超级管理员</#if></td>
                    <td style="text-align: center;font-size: large;">
                        <div class="btn-group" role="group" aria-label="...">
                            <button type="button" class="btn btn-default" style="background-color: peachpuff" onclick="window.location.href='${pagecontext.request.contextpath}/manager/resetpwd?&id=${case.id}'">
                                <span class="glyphicon glyphicon-floppy-save" style="color: #18d4cb;" aria-hidden="true" ><font style="font-size: large">&nbsp;重置密码</font></span>
                            </button>

                            <button type="button" class="btn btn-default" style="background-color: peachpuff" onclick="window.location.href='${pagecontext.request.contextpath}/manager/removemanager?id=${case.id}'">
