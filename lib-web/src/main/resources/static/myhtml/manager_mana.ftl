                ...
                <tr>
                    ...
                    <td style="text-align: center;font-size: large;">
                        <div class="btn-group" role="group" aria-label="...">
                            <button type="button" class="btn btn-default" style="background-color: peachpuff" onclick="top.location.href='${pagecontext.request.contextpath}/manager/resetpwd?&id=${case.id}'">
                                <span class="glyphicon glyphicon-floppy-save" style="color: #18d4cb;" aria-hidden="true" ><font style="font-size: large">&nbsp;重置密码</font></span>
                            </button>

                            <button type="button" class="btn btn-default" style="background-color: peachpuff" onclick="top.location.href='${pagecontext.request.contextpath}/manager/removemanager?id=${case.id}'">
